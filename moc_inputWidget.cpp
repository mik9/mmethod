...
**
** Created: Wed Apr 14 00:46:57 2010
...
static const char qt_meta_stringdata_inputWidget[] = {
    "inputWidget\0\0nEqChanged(QSize)\0"
    "argsChanged(int)\0eqChanged(int)\0"
};
...
int inputWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: nEqChanged((*reinterpret_cast< QSize(*)>(_a[1]))); break;
        case 1: argsChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: eqChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 0
void inputWidget::nEqChanged(QSize _t1)
{
